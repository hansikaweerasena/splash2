...
GetArguments ()
{
   ...
   Total_Particles = 16384;//atoi(gets(input));
   
   Precision = 1e-6;//atof(gets(input));
   ...
   Number_Of_Processors = 1;//atoi(gets(input));
   ...
   Timestep_Dur = 0.025;//atof(gets(input));
   if (Timestep_Dur == 0.0) {
   ...
   Softening_Param = 0.0;//atof(gets(input));
